	...
	*/
	...
	$.fn.keynav = function (onClass,offClass) {
		...
		if(!kn.init) {
			...
			$(document).keydown(function(e) {
				e.preventDefault(); // V: had to add this
				var key = 0;
				if (e == null) {
					key = event.keyCode;
				} else { // mozilla
	...
	$.keynav.activateClosest = function(dir, cur,quad) {
		var closest;
		var od = 1000000;
		var nd = 0;
		var found = false;
	...
	$.keynav.goLeft = function() {
		...
		$.keynav.activateClosest("left", cur,quad);
	}
	...
	$.keynav.goRight = function() {
		...
		$.keynav.activateClosest("right", cur,quad);
	}
	...
	$.keynav.goUp = function() {
		...
		$.keynav.activateClosest("up", cur,quad);
	}
	...
	$.keynav.goDown = function() {
		...
		$.keynav.activateClosest("down", cur,quad);
	}
